...
Most of my work sits at the intersection of space technology, environmental monitoring, and intelligent spatial systems. If you're building something in that space, let's talk.
...
> Most professional work is in private repos. Live demos and write-ups are on my [portfolio](https://mariamushtaq-12.github.io/ePortfolio/).

---

### Skills

**Web GIS** — OpenLayers · Leaflet · CesiumJS · GeoServer · PostGIS · WMS/WFS  
**Earth Observation** — Remote Sensing · EO Data Cubes · PyWaPOR · Drought & vegetation analysis  
**ML & AI** — scikit-learn · TensorFlow · PyTorch · Spatial ML · GeoAI  
**Dev Stack** — Node.js · Angular · Python · PostgreSQL · REST APIs · Docker  

---
### Currently

- 📚 Erasmus Mundus master's in Digital Earth (Salzburg + Olomouc)
- 🔨 Building a geospatial data quality evaluation platform 
- 🔭 Exploring GeoAI, spatial knowledge graphs, and cloud-native geospatial architectures
